...
def normal_grouped_gemm_triton(x, y, out, num_groups, weight_column_major=True, seg_indptr=None, weight_indices=None):
    grouped_gemm_triton(x, y, out, num_groups, weight_column_major=weight_column_major, seg_indptr=seg_indptr, weight_indices=weight_indices)
    return out
