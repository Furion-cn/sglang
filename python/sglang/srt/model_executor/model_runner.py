...
class ModelRunner:
    ...
    def _forward_raw(
        ...
        logger.info(f"forward_batch: batch_size{forward_batch.batch_size} seq_len{forward_batch.seq_lens} seq_lens_sum{forward_batch.seq_lens_sum}, can_run_cuda_graph: {can_run_cuda_graph}")
        if can_run_cuda_graph:
            ...
            if ret.next_token_logits is not None:
